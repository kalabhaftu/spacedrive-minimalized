...
- [ ] Create task file in /.tasks/interface/
- [ ] Update useSidebarStore with persisted collapsedGroups Record and showInternalVolumes flag
- [ ] Add "Show internal & system volumes" toggle in LibrarySettings.tsx and GeneralSettings.tsx
- [ ] Implement internal system volume filtering in VolumesGroup.tsx based on showInternalVolumes setting
- [ ] Update core volume classification to properly classify cryptex/assets disk images as System / non-user-visible
- [ ] Re-order sidebar groups in SpacesSidebar/index.tsx to place Locations first, Volumes second, Tags third
- [ ] Configure default collapsing for empty groups in SpaceGroup.tsx and TagsGroup.tsx
- [ ] Verify build and validate task file
