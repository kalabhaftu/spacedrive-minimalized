...
<h1 align="center">Spacedrive Minimalized</h1>

<p align="center">
  <strong>Fast, minimalized, and optimized file manager based on Spacedrive.</strong><br/>
	<span>Re-architected for instant live filesystem browsing and resource efficiency.</span>
</p>

<p align="center">
  <a href="https://github.com/kalabhaftu/spacedrive-minimalized">
    <img src="https://img.shields.io/static/v1?label=Repo&message=spacedrive-minimalized&color=blue" />
  </a>
  <a href="https://github.com/kalabhaftu/spacedrive-minimalized">
...
```bash
git clone https://github.com/kalabhaftu/spacedrive-minimalized
cd spacedrive-minimalized
```
...
This project is a fork of and based upon the open-source [Spacedrive](https://github.com/spacedriveapp/spacedrive) project created by Jamie Pine and the Spacedrive community. We are grateful to all original authors and contributors for their foundational work.
